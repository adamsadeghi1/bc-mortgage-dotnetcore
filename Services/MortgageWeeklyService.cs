...
{
	public class MortgageWeeklyService : MortgageAbstract, IMortgageCalculate
    {
        ...
        {
            return period * Constants.WEEK_IN_YEAR;
        }

        public override double GetRate(double annualInterestRate)
        {
            return Math.Pow(1 + (double) annualInterestRate / Constants.PERCENT, (double) 1 / Constants.WEEK_IN_YEAR) - 1;
        }
    }
}
